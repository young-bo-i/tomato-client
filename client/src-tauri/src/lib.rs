...
pub fn run() {
  ...
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      // KOL automation commands
      kol_automation::kol_login_kol_platform,
      kol_automation::kol_login_douyin,
      kol_automation::kol_refresh_kol,
      kol_automation::kol_refresh_douyin,
